...
export default function GhiduriPage() {
  ...
  // click → „MARIAN!”, iar după strigăt se deschide un ghid nou.
  ...
  const marianCreate = () => {
    ...
    // audio blocat sau mp3 lipsă → mergem direct la ghid; plasă de
    ...
    <main className="mx-auto w-full max-w-3xl flex-1 px-4 sm:px-8 pb-16 pt-8">
        ...
        <div>
          ...
          <p className="mt-1 text-base text-muted-foreground">
            ...
            <span className="loom-vadim-only">
              Click pe imagine să-l cheme Tribunul pe Marian, să te ajute cu
              ghidul.
            </span>
          </p>
        </div>
      ...
      {vadim && (
        ...
        <button
          ...
          aria-label="Cheamă-l pe Marian și deschide un ghid nou"
        >
          {strigat && (
          ...
          {/* fără duotonul portocaliu — poza rămâne naturală, la cerere */}
          <svg
          ...
          <span className="vadim-caption">
            ...
            Un click: Tribunul îl strigă pe Marian, iar ghidul nou se deschide
            imediat.
          </span>
        </button>
        </span>
